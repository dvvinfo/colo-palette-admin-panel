<template>
  <AdminLayout
    ...
    page-description="Статистика, метрики и бизнес-аналитика"
  >
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
      <div class="bg-card-bg rounded-2xl p-4 md:p-6 shadow-lg">
        <div class="flex items-center gap-3 md:gap-4">
          ...
          <div>
            <p class="text-gray-400 text-xs md:text-sm">Уникальные посетители</p>
            <p class="text-white text-xl md:text-2xl font-bold">12,543</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-card-bg rounded-2xl p-4 md:p-6 shadow-lg">
        <div class="flex items-center gap-3 md:gap-4">
          ...
          <div>
            <p class="text-gray-400 text-xs md:text-sm">Доходность</p>
            <p class="text-white text-xl md:text-2xl font-bold">+24.3%</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-card-bg rounded-2xl p-4 md:p-6 shadow-lg">
        <div class="flex items-center gap-3 md:gap-4">
          ...
          <div>
            <p class="text-gray-400 text-xs md:text-sm">Средняя ставка</p>
            <p class="text-white text-xl md:text-2xl font-bold">156 ₽</p>
          </div>
        </div>
      </div>
      ...
      <div class="bg-card-bg rounded-2xl p-4 md:p-6 shadow-lg">
        <div class="flex items-center gap-3 md:gap-4">
          ...
          <div>
            ...
            <p class="text-white text-xl md:text-2xl font-bold">8.7%</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-card-bg rounded-2xl p-4 md:p-6 shadow-lg mb-4 md:mb-6">
      <div class="flex flex-col md:flex-row gap-3 md:gap-4">
        <div class="flex-1">
          <label class="block text-gray-400 text-sm mb-2">Период</label>
        ...
        <div class="w-full sm:w-auto md:w-48">
          <label class="block text-gray-400 text-sm mb-2">Метрика</label>
          <select class="w-full bg-background border border-white/10 rounded-lg px-3 md:px-4 py-2.5 md:py-3 text-white focus:border-primary focus:outline-none text-sm md:text-base">
        ...
        <div class="w-full sm:w-auto md:w-48">
          <label class="block text-gray-400 text-sm mb-2">Группировка</label>
          <select class="w-full bg-background border border-white/10 rounded-lg px-3 md:px-4 py-2.5 md:py-3 text-white focus:border-primary focus:outline-none text-sm md:text-base">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
      <!-- График доходов -->
      <div class="bg-card-bg rounded-2xl p-4 md:p-6 shadow-lg">
        <h3 class="text-lg md:text-xl font-bold text-white mb-4">Динамика доходов</h3>
        <div class="h-64 flex items-center justify-center border-2 border-dashed border-white/10 rounded-lg">
          <div class="text-center">
            ...
            <p class="text-gray-400 text-sm md:text-base">График будет здесь</p>
          </div>
        </div>
      </div>
      ...
      <!-- Популярные игры -->
      <div class="bg-card-bg rounded-2xl p-4 md:p-6 shadow-lg">
        <h3 class="text-lg md:text-xl font-bold text-white mb-4">Топ игр по доходности</h3>
        <div class="h-64 flex items-center justify-center border-2 border-dashed border-white/10 rounded-lg">
          <div class="text-center">
            <svg class="w-12 h-12 md:w-16 md:h-16 text-gray-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>
            </svg>
            <p class="text-gray-400 text-sm md:text-base">Диаграмма будет здесь</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="bg-card-bg rounded-2xl p-4 md:p-6 shadow-lg">
      <div class="flex items-center justify-between mb-4 md:mb-6">
        <h2 class="text-xl md:text-2xl font-bold text-white">Детальная аналитика</h2>
      ...
      <div class="text-center py-12">
        <div class="w-16 h-16 md:w-20 md:h-20 mx-auto mb-4 bg-blue-500/20 rounded-full flex items-center justify-center">
          <svg class="w-8 h-8 md:w-10 md:h-10 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
          </svg>
        </div>
        <h3 class="text-lg md:text-xl font-bold text-white mb-2">Модуль аналитики в разработке</h3>
        <p class="text-gray-400 text-sm md:text-base mb-6">
          Расширенная система отчетов и бизнес-аналитики.<br>
          Интеграция с современными инструментами визуализации данных.
        </p>
